...
public class PropertySheetViewer extends Viewer {
    ...
    private void updateCategories() {
        ...
        Map<String, PropertySheetCategory> categoryCache = new HashMap<String, PropertySheetCategory>(categories.length * 2 + 1);
        ...
        List<PropertySheetCategory> categoriesToRemove = new ArrayList<PropertySheetCategory>(Arrays.asList(categories));
